...
class TestClassDiagram:
    ...
    def test_generate_all_includes_class_diagrams(self) -> None:
        """Class diagrams are included in generate_all_diagrams output."""
        comp = Component(
            id="test-comp",
            name="Test",
...
class TestPartitionedClassDiagrams:
    ...
    def test_generate_all_includes_class_diagrams_with_large_data(self) -> None:
        """Large class sets produce partitioned class diagrams."""
        comp = Component(
            id="test-comp",
            name="Test",
            description="Test component",
    ...
    def test_generate_all_includes_class_diagrams_with_namespaces(self) -> None:
        """Namespaced class data produces class diagrams."""
        comp = Component(
            id="test-comp",
            name="Test",
            description="Test component",
