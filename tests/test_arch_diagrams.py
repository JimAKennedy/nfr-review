...
class TestClassDiagram:
    ...
    def test_generate_all_excludes_class_diagrams(self) -> None:
...
class TestPartitionedClassDiagrams:
    ...
    def test_generate_all_excludes_class_diagrams_even_with_large_data(self) -> None:
        """Class diagrams are now generated by the experimental orchestrator."""
        comp = Component(
            id="test-comp",
            name="Test",
    ...
    def test_generate_all_excludes_class_diagrams_with_namespaces(self) -> None:
        """Class diagrams are now generated by the experimental orchestrator."""
        comp = Component(
            id="test-comp",
            name="Test",
