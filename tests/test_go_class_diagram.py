...
class TestMmcdSyntaxValidation:
    ...
    def test_mmdc_validates_ungrouped(self, all_structs: list[dict]) -> None:
        from nfr_review.arch_diagrams import render_class_diagram

        d = render_class_diagram(all_structs, title="Go Ungrouped")
        _assert_mmdc_parses(d.mermaid, "go ungrouped")

    def test_mmdc_validates_grouped(self, all_structs: list[dict]) -> None:
        from nfr_review.arch_diagrams import render_class_diagram

        d = render_class_diagram(all_structs, title="Go Grouped", group_by_namespace=True)
        _assert_mmdc_parses(d.mermaid, "go grouped")
