...
class TestMmcdSyntaxValidation:
    ...
    def test_mmdc_validates_ungrouped(self, all_classes: list[dict]) -> None:
        ...
        d = render_class_diagram(all_classes, title="Python Ungrouped")
        _assert_mmdc_parses(d.mermaid, "python ungrouped")

    def test_mmdc_validates_grouped(self, all_classes: list[dict]) -> None:
        from nfr_review.arch_diagrams import render_class_diagram

        d = render_class_diagram(all_classes, title="Python Grouped", group_by_namespace=True)
        _assert_mmdc_parses(d.mermaid, "python grouped")
